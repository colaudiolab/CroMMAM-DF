...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='MAV', help='chooses which model to use.')
        ...
        parser.add_argument('--patch_size', default=16, type=int, help='model.encoder.patch_embed.patch_size')
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='VoxCeleb2', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
        # parser.add_argument('--serial_batches', action='store_true', help='if true, takes images in order to make batches, otherwise takes them randomly')
        parser.add_argument('--shuffle', type=bool, default=True, help='if true, takes images randomly, otherwise takes them in order to make batches')
        ...
        parser.add_argument('--sampling_rate', type=int, default= 1, help='sample one frame from video every step')
        parser.add_argument('--setting', type=str, default= 'train', help='the file that include video path and label')
